        ...
        <div class="relative z-10 container mx-auto max-w-4xl text-center">
            ...
            <div
                ...
                <div class="space-y-2">
                    ...
                    <div class="text-blue-200">Developer subscribers</div>
                </div>
                <div class="space-y-2">
                    <div class="text-3xl font-bold text-purple-300">Weekly</div>
                    <div class="text-blue-200">Security insights</div>
                </div>
                <div class="space-y-2">
                    <div class="text-3xl font-bold text-teal-300">Beta</div>
                    <div class="text-blue-200">Early access</div>
                </div>
            </div>
        </div>
    </section>
